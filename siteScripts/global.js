...
// Add this to your existing overlays object/module

  viewer: {
  unified: (title, content) => {
    let modalEl = document.getElementById('unified-modal');
    
    if (!modalEl) {
      modalEl = document.createElement('div');
      modalEl.id = 'unified-modal';
  ...
  playlists: (content) => {
    let modalEl = document.getElementById('playlist-viewer');
    
    if (!modalEl) {
      modalEl = document.createElement('div');
      modalEl.id = 'playlist-viewer';
      modalEl.className = 'modal-overlay';
      modalEl.innerHTML = `
        <div class="modal-content">
          <div class="modal-header">
