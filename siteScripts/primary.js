// ============================================================================
// PRIMARY.JS - Main Application Initialization and Core Functionality
// ============================================================================
// Consolidates main application logic from:
// - init.js
// - global.js (core app state and functions)
// - unifiedPlayerController.js
// - unifiedPlayerIntergration.js
// ============================================================================

// Import all dependencies
import { bustCache, initTheme, initPWABanner, registerServiceWorker, initBreadcrumbBorder } from './helpers.js';
import { IDS, CLASSES, ROUTES, STORAGE_KEYS, NOTIFICATION_TYPES } from './map.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialize desktop layout if needed
...
/**
 * Initialize unified player system for responsive layouts
 */
...
/**
 * Setup responsive window resize listeners
 */
...
/**
 * Setup unified menu and player triggers for all device types
 */
...
/**
 * Setup bento grid integration for desktop layout
 */
...
// ============================================================================
// APP INITIALIZATION (to be called from index.html)
// ============================================================================
...
export const app = {
  ...
  async initialize() {
    ...
    try {
      ...
      // Set up any additional global event listeners
...
function setupGlobalEventListeners() {
  ...
  document.addEventListener('keydown', (e) => {
    // ESC to close modals
    if (e.key === 'Escape') {
      const modals = document.querySelectorAll('[popover]:popover-open');
      modals.forEach(modal => modal.hidePopover());
    }
...
// Export app initialization to window for use in index.html
