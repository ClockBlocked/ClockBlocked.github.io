...
const dropdown = {
  toggle: (e) => {
    e?.preventDefault();
    e?.stopPropagation();
    const menu = PAGE.$byId(PAGE.dropdownMenu);
    const trigger = PAGE.$byId(PAGE.menuTrigger);
...
const playlists = {
    ...
    show: (playlistId) => {
        ...
        setTimeout(() => {
            const dynamicContent = PAGE.$byId(PAGE.dynamicContent);
    ...
    bindEvents: (root = PAGE.$byId(PAGE.dynamicContent)) => {
