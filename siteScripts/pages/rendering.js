...
pages: {
  loadHomePage: () => {
    ...
    viewManager.switchView('home').then(() => {
        ...
        [
          {
            ...
            active: true,
            isHome: true,
            icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M125.2 16.1c6.2-4.4 5.4-14.8-2.2-15.6c-3.6-.4-7.3-.5-11-.5C50.1 0 0 50.1 0 112s50.1 112 112 112c32.1 0 61.2-13.7 81.5-35.5l-1.2-1.7zm0 0"/></svg>'
          }
        ],
        {
          showIcons: true,
  ...
  loadArtistPage: (artistData, targetAlbumName = null) => {
    ...
    viewManager.switchView('artist', { artistData }).then(() => {
      pageUpdates.breadCrumbs(
        [
          { 
            text: "Home  ", 
            ...
            active: false, 
            isHome: true, 
            icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path class="fa-secondary" d="M80 202.9L80 448c0 26.5 21.5 48 48 48l80 0 0-168c0-13.3 10.7-24 24-24l112 0c13.3 0 24 10.7 24 24l0 168 80 0c26.5 0 48-21.5 48-48l0-245.1-176-141L80 202.9z"/></svg>'
          },
          { 
            text: "  Discography", 
            route: ROUTES.ARTIST, 
  ...
  loadAllArtistsPage: () => {
    ...
    viewManager.switchView('allArtists').then(() => {
