...
const UI = {
  ...
  updateBreadcrumb: function() {
    ...
    let html = `
      <a href="#" onclick="Router.showRepoSelector()" class="text-github-accent-fg hover:underline font-semibold">Repositories</a>
      <span class="text-github-fg-muted">/</span>
      <a href="#" onclick="Router.navigateToRoot()" class="text-github-accent-fg hover:underline font-semibold">${currentState.repository}</a>
    `;
    if (currentState.path) {
      ...
      segments.forEach((segment, index) => {
        ...
        html += `
          <span class="text-github-fg-muted">/</span>
          <a href="#" onclick="Router.navigateToPath('${currentPath}')" class="text-github-accent-fg hover:underline font-semibold">${segment}</a>
        `;
      });
    }
    breadcrumb.innerHTML = html;
  },
  updateEditorMode: function(editor, fileName) {
...
window.showCreateFileModal = ModalManager.showCreateFileModal;
window.hideCreateFileModal = ModalManager.hideCreateFileModal;
window.showDeleteFileModal = ModalManager.showDeleteFileModal;
window.hideDeleteFileModal = ModalManager.hideDeleteFileModal;
window.createRepository = RepositoryManager.createRepository;
window.createFile = FileManager.createFile;
window.confirmDeleteFile = FileManager.confirmDeleteFile;
window.deleteRepository = RepositoryManager.deleteRepository;
window.openRepository = RepositoryManager.openRepository;
window.viewFile = FileManager.viewFile;
window.editFile = FileManager.editFile;
window.saveFile = FileManager.saveFile;
window.downloadCurrentFile = FileManager.downloadCurrentFile;
window.previewFile = FileManager.previewFile;
window.showRepoSelector = Router.showRepoSelector;
window.showExplorer = Router.showExplorer;
window.showFileViewer = Router.showFileViewer;
window.showFileEditor = Router.showFileEditor;
window.navigateToRoot = Router.navigateToRoot;
window.navigateToPath = Router.navigateToPath;
window.addTag = TagManager.addTag;
window.removeTag = TagManager.removeTag;
window.viewFileFromContext = ContextMenu.viewFileFromContext;
